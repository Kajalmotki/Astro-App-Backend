                        ...
                        {sources.map((s, i) => (
                            <g key={i}>
                                ...
                                <g transform={`translate(${s.x}, ${s.y})`} className="source-node">
                                    <rect x="0" y="-30" width="180" height="60" rx="10" className="node-rect" fill="rgba(20, 20, 40, 0.8)" stroke="rgba(255, 215, 0, 0.15)" strokeWidth="1" />
