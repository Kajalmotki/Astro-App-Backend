    ...
    return (
        <div className="auth-modal-overlay" onClick={onClose}>
            <div className="auth-modal glass-card" onClick={(e) => e.stopPropagation()}>
                <h2 className="gold-text">{isLogin ? 'Sign In' : 'Create Account'}</h2>
                <p className="auth-subtitle">Access your personalized AstroRevo insights</p>
                ...
                <button onClick={handleGoogleAuth} className="auth-btn google" disabled={loading}>
